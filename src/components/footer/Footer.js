                    ...
                    <Row>
                        ...
                        <Col md={8}>
                            <Row>
                                ...
                                <Col md={2}>
                                    ...
                                    <Row><a href={"https://insights.thoughtworks.cn/"}><span
                                        className="footerText">ThoughtWorks洞见</span></a></Row>
                                    <Row><a href={"https://www.thoughtworks.com/cn/radar"}><span
                                        className="footerText">ThoughtWorks技术雷达</span></a></Row>
                                </Col>
                                <Col md={6} style={{padding: 0, margin: 0, textAlign: 'right'}}>
                                    <a href={'https://www.youtube.com/user/thoughtworks'}>
                                        <Col style={{
                                            ...
                                            <svg id="youtube-icon" viewBox="0 0 40 40"
                                    ...
                                    <a href={'https://github.com/LabZion'}>
                                        <Col style={{
                                            ...
                                            <svg id="github-icon" viewBox="0 0 75.93 75.93"
                                                 xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href={'https://twitter.com/thoughtworks'}>
                                        <Col style={{width: '40px', display: "inline-block", padding: 0}}>
                                            <svg id="twitter-icon" viewBox="0 0 75.93 75.93"
                                                 xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Row style={{marginTop: '1em', padding: 0}}>
                                <Col md={12}>
                                    <Row style={{display: 'inline-block', float: 'left'}}><Image
                                        style={{height: '4em', marginLeft: 0}} src={Logo}/> </Row>
                                    <Row style={{
                                        color: '#999',
                                        display: 'inline-block',
                                        float: 'right',
