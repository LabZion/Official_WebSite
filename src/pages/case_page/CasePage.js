                ...
                <Row style={{background: '#fff'}}>
                    ...
                    <Col md={7}>
                        <Container style={{textAlign: "left", paddingTop: '2em', paddingBottom: '1em'}}>
                            <h1>客户简介</h1>
                            <p>我们的客户是全球领先的下一代电信网络解决方案供应商，致力于向客户提供创新的满足其需求的产品、服务和解决方案，为客户创造长期的价值和潜在的增长。我们的客户在全球建立了100多个分支机构，营销及服务网络遍及全球，能够为客户提供快速、优质的服务。目前，产品和解决方案已经应用于全球100多个国家，以及31个全球前50强的运营商，服务全球超过10亿用户。</p>
                        </Container>
                        <Container style={{textAlign: "left", paddingTop: '2em', paddingBottom: '1em'}}>
                            <h1>业务挑战</h1>
                            <p>随着公司业务逐步规划上云并面向互联网开放，传统企业网络安全边界开始变得模糊，安全高效的基于云的身份认证与访问控制平台将成为未来应用访问的“边界”，在这种情况下，传统企业内网的身份验证与IAM系统已无法满足业务上云后日益发展的需求。因为企业的业务场景极其复杂，内部私有云已无法支撑所有的业务系统，但市场上的公有云也无法满足企业内部的要求与限制。如何将内部云与公有云结合使用，符合企业内部的合规要求，使用公有云与私有云的能力是企业亟需解决的一个问题。</p>
                            <div style={{textAlign:'center'}}><img src='https://raw.githubusercontent.com/LabZion/Official_WebSite/master/public/picture/%E4%BA%91%E5%AE%89%E5%85%A8.png'width='60%' ></img></div>
                            <p style={{paddingTop:'2em'}}>客户拥有一个私有云平台，来自内部和外部的研发人员都需要在这个平台上访问服务和资源。客户企业内部有一万多个部门和服务，每个部门和都可能访问私有云平台。另一方面，身份认证与访问控制系统建设过程中需要结合具体业务场景进行系统接入和部署，应用过程中需要按照实际情况进行配置和调整。且涉及到周边系统配合改造，业务逻辑复杂，开发难度高。</p>
                        </Container>
                        <Container style={{textAlign: "left", paddingTop: '2em', paddingBottom: '1em'}}>
                            <h1>解决方案</h1>
                            <p>Thoughtworks安全BU面向除了客户企业员工以外的合作伙伴、供应商、客户和消费者提供移动办公套件身份认证服务。服务包括标准的SAML/OAuth等Web、移动应用认证和授权协议，提供基于多因子和风险控制分析的强身份认证，集成社交账号和企业账号联邦认证，并实现多租户管理等。核心价值包括以下几点：</p>
                            <h5>SSO单点登录</h5>
                            <p>采用业内标准协议实现SSO单点登录,为企业所有部门提供统一的登录入口，打通部门间的认证壁垒，减少用户操作，提高生产效率。</p>
                            <div style={{textAlign:'center'}}><img src='https://raw.githubusercontent.com/LabZion/Official_WebSite/master/public/picture/SSO.png'width='80%'></img></div>
                            ...
                            <div style={{textAlign:'center'}}><img src='https://raw.githubusercontent.com/LabZion/Official_WebSite/master/public/picture/%E4%BA%A7%E5%93%81%E5%8C%96.png'width='80%'></img></div>
                        </Container>
                        <Container style={{textAlign: "left", paddingTop: '2em', paddingBottom: '1em'}}>
                            <h1>客户价值</h1>
