        ...
        data: [
            ...
            },
            {
                ...
                content:'## 某通信行业巨头信息资产安全审计案例\n' +
                    ...
                    '\n' +
                    '### ![img](https://raw.githubusercontent.com/LabZion/Official_WebSite/master/public/picture/cases/22.png)\n' +
                    '\n' +
                    ...
                    '\n' +
                    '![img](https://raw.githubusercontent.com/LabZion/Official_WebSite/master/public/picture/cases/23.png#width-90)\n' +
                    '\n' +
                    '### 客户价值\n' +
                    '\n' +
                    '\n' +
                    '\n' +
                    'Thoughtworks安全BU研发的智能信息资产管控软件改进了客户的旧版本软件只能监控和审计特定软件，无法达到系统级别的监控的问题。另一方面，通过定制化开发来满足业务需求，提供了兼容多PC平台的软件，完美地解决了客户的问题。适用于企业内部大规模使用PC端工作，重视资源的安全与保护，企业对不同角色员工的访问权限有定制化需求，以及企业想要自定义内部资源类型，比如定义哪些属于敏感信息等场景。助力企业大幅度性能提升，为员工提供无障碍体验。'
            },
        ...
        data: [
            {
                ...
                content:'## 某国内药企基础设施安全治理案例\n' +
                    ...
                    '\n' +
                    '![311](/Users/wuyunfeng/Desktop/311.png)\n' +
                    '\n' +
                    '\n' +
                    '\n' +
                    ...
                    '\n' +
                    '![312](/Users/wuyunfeng/Desktop/312.png)\n' +
                    '\n' +
                    '### 客户价值\n' +
                    '\n' +
                    '\n' +
