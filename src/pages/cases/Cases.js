        ...
        data: [
            {
                ...
                content:
                    ...
                    '\n' +
                    '###客户简介\n' +
                    '>我们的客户是全球领先的ICT（信息与通信）基础设施和智能终端提供商，拥有健康良性的产业生态系统，面向云计算等新兴热点领域，与产业伙伴分工协作，推动产业持续良性发展。\n' +
                    '\n' +
                    '>###业务挑战\n' +
            ...
            },
            {
                ...
                content:
                    ...
                    '\n' +
                    '\n' +
                    '我们的客户为政府及公共事业机构、金融、能源、交通、制造等企业客户，提供开放、灵活、安全的端管云协同ICT基础设施平台，推动行业数字化转型，帮助人们享受高品质的数字工作、生活和娱乐体验。\n' +
                    '\n' +
                    '### 业务挑战\n' +
                    '\n' +
                    '\n' +
                    ...
                    '\n' +
                    '\n' +
                    'ThoughtWorks安全团队研发的智能信息资产管控软件改进了客户的旧版本软件只能监控和审计特定软件，无法达到系统级别的监控的问题。在多PC平台上实现权限控制功能的同时为员工提供了顺畅的系统使用体验，成功让审计流程在系统中透明化、无感化。适用于企业内部大规模使用PC端工作，重视资源的安全与保护，企业对不同角色员工的访问权限有定制化需求，以及企业想要自定义内部资源类型，比如定义哪些属于敏感信息等场景。助力企业大幅度性能提升，为员工提供无障碍体验。'
            },
            {
                ...
                content:
                    ...
                    '\n' +
                    '\n' +
                    '我们的客户在全球建立了100多个分支机构，营销及服务网络遍及全球，能够为客户提供快速、优质的服务，同时也维护着跨越全球而且复杂的企业内网。\n' +
                    '\n' +
                    '### 业务挑战\n' +
                    '\n' +
                    '\n' +
            ...
            },
            {
                ...
                content:
                    ...
                    '\n' +
                    '\n' +
                    '我们的客户是全球领先的基础设施提供商，拥有庞大的体量、数量众多的员工以及雄厚的研发实力，一直致力于向客户提供创新的满足其需求的产品、服务和解决方案。其产品线和产品数量非常丰富，所以其产品的维护成本也是居高不下，其中涉及到安全的维护成本也贡献了相当的比例。\n' +
                    '\n' +
                    '### 业务挑战\n' +
                    '\n' +
                    '\n' +
                    ...
                    '\n' +
                    '\n' +
                    'ThoughtWorks安全团队提供的四步白盒验证方案帮助企业建立了统一的检验标准和流程，保证产品在CESG检查之前先在内部实现风险管控，在源头处对产品合规进行把控，减小企业风险与损失。'
            },
